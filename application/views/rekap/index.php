	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-10">
					<form action="<?= base_url('Rekap_laporan'); ?>" method="POST">
						...
						<div class="row col-md-12">
							...
							<div class="col-md-4">
								...
								<a href="<?= base_url('Rekap_laporan/cetak?tglawal=') . $tanggalawal . '&tglakhir=' . $tanggalakhir; ?>" name="cetak" class="btn btn-danger btn-col-1" target="_blank" role="button" aria-disabled="true"><i class="icon-copy dw dw-print"></i> Cetak</a>
							</div>
						</div>
					</div>
				</form>
